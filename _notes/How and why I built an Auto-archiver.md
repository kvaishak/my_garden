...
1. Once the node server starts it fetches my data from WakaTime in two ways -
   - A simple API call that Wakatime provides using which you can get your last 7 days data. Documentations [here](https://wakatime.com/developers#stats).
